...
public class SpoutNoClipNetServerHandler extends SpoutNetServerHandler {
    ...
    public SpoutNoClipNetServerHandler(MinecraftServer minecraftserver, NetworkManager networkmanager, EntityPlayer entityplayer) {
